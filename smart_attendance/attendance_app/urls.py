"""
urls.py — URL Patterns for attendance_app
==========================================
Maps URL paths to view functions.
All app URLs are included by the project urls.py.
"""
...
urlpatterns = [
    ...
    # Only admin (is_staff) can access these pages
    ...
    # Called via AJAX from mark_attendance page (webcam frame recognition)
